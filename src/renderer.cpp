...
void Renderer::SetupTriangle()
{
	...
	{
		m_Device.Get(),
		L"../../../src/shaders/vertexShader.hlsl",
		L"../../../src/shaders/pixelShader.hlsl",
...
void Renderer::SetupCube()
{
	...
	{
		m_Device.Get(),
		L"../../../src/shaders/CubeInstancing_Vs.hlsl",
		L"../../../src/shaders/pixelShader.hlsl",
		std::move(vertexShaderInputLayout)
	};
...
void Renderer::SetupSpaceShip()
{
	...
	{
		m_Device.Get(),
		L"../../../src/shaders/SpaceshipVertexShader.hlsl",
		L"../../../src/shaders/SpaceshipPixelShader.hlsl",
