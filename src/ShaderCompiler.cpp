...
{
    m_Include = new D3DInclude("../../../src/shaders", "../../../src/");
}

ComPtr<ID3DBlob> ShaderCompiler::CompileShader(LPCWSTR filePath, const std::vector<const char*> shaderDefines, const char* entryPoint, ShaderType shaderType)
{
    // setting macros
