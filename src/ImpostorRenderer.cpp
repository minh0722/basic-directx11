...
void ImpostorRenderer::Initialize(Renderer* renderer)
{
    ...
    ComPtr<ID3DBlob> blob = shaderCompiler.CompileShader(L"../../../src/shaders/ImpostorRenderVS.hlsl", {}, "main", ShaderType::VS);
    ...
    blob = shaderCompiler.CompileShader(L"../../../src/shaders/ImpostorRenderPS.hlsl", {}, "main", ShaderType::PS);
    ...
    ComPtr<ID3DBlob> vertexBlob = Renderer::GetInstance().GetShaderCompiler().CompileShader(L"../../../src/shaders/ImpostorRenderVS.hlsl", {}, "main", ShaderType::VS);
