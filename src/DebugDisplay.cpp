...
void DebugDisplay::Setup3DBoxesRenderState(ID3D11Device* device)
{
    ...
    LPCWSTR path = L"../../../src/shaders/debugdisplay3dbox.hlsl";

    ComPtr<ID3DBlob> compiledBlob = shaderCompiler.CompileShader(L"../../../src/shaders/debugdisplay3dbox.hlsl", {}, "main", ShaderType::VS);
    ...
    THROW_IF_FAILED(
        device->CreateVertexShader(
            ...
            nullptr, 
            m_3DBoxVS.ReleaseAndGetAddressOf())
    );

    compiledBlob = shaderCompiler.CompileShader(L"../../../src/shaders/pixelShader.hlsl", {}, "main", ShaderType::PS);
    ...
    THROW_IF_FAILED(
        device->CreatePixelShader(
            ...
            compiledBlob->GetBufferSize(), 
            nullptr, 
            m_3DBoxPS.ReleaseAndGetAddressOf())
    );
}
